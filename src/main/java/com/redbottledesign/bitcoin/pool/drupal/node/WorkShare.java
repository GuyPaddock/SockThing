...
extends Node
{
    ...
    public static final String DRUPAL_FIELD_WORKER_NAME             = "field_share_worker";
    public static final String JAVA_FIELD_WORKER_NAME               = "workerName";

    public static final String DRUPAL_FIELD_WORKER_DIFFICULTY       = "field_share_worker_difficulty";
    public static final String JAVA_FIELD_WORKER_DIFFICULTY         = "workerDifficulty";
    ...
    @SerializedName(DRUPAL_FIELD_WORKER_DIFFICULTY)
    private int workerDifficulty;
    ...
    public int getWorkerDifficulty()
    {
        return this.workerDifficulty;
    }

    public void setWorkerDifficulty(int workerDifficulty)
    {
        this.workerDifficulty = workerDifficulty;
    }
    ...
    public String toString()
    {
      return this.getClass().getSimpleName()                        + " [" +
             ...
             "workerDifficulty="      + this.workerDifficulty       + ", " +
